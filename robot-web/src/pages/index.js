  ...
  const [messages, setMessages] = useState([
    {
      role: "system",
      content:
        "You are ROBot, an intuitive AI designed with OpenAI's state-of-the-art GPT-3 technology using machine learning and natural language processing.",
    },
  ]);
      ...
      <div className="flex flex-col h-screen">
        ...
        <nav className="bg-white shadow w-full">
          <div className="px-4 h-14 flex justify-between items-center">
            <div className="text-xl font-bold">ROBot</div>
            <div>
              <input
                type="password"
